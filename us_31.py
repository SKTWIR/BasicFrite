...
# Défis rapides à faire en plus d'une séance.
CHALLENGE_LIST = [
    # --- GAINAGE & ABDOS (Core) ---
    ...
    "Aller aux toilettes et faire caca pendant au moins 2h",
...
def show_random_challenge():
    """
    Cette fonction crée la fenêtre pop-up et y affiche un défi au hasard.
    """
...
root = tk.Tk()
root.title("Générateur de Défis")
root.geometry("400x250")
root.configure(bg="#34495E") # Fond bleu-gris

# Un label de titre
# main_label = tk.Label(
#     root,
#     text="Un petit plus pour finir ?",
#     font=("Arial", 18, "bold"),
#     bg="#34495E",
#     fg="#ECF0F1",
#     pady=30
...
# Le bouton principal qui lance la pop-up
challenge_button = tk.Button(
    root,
    text="⚡ Défis ⚡",
    font=("Arial", 14, "bold"),
    command=show_random_challenge,
    bg="#2ECC71", # Vert
    fg="#FFFFFF", # Blanc
    relief="flat",
    padx=20,
